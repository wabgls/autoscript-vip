...
Exp2=$(curl -sS https://raw.githubusercontent.com/wabgls/permission/main/ip | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
...
clear;clear;clear
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│${NC} ${COLBG1}               ${WH} • BOGEL STORE PREMIUM •               ${NC} $COLOR1│ $NC"
echo -e " $COLOR1╰══════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
...
cd
rm -rf *
wget https://raw.githubusercontent.com/wabgls/autoscript-vip/main/m-update.sh
clear

...
data_ip="https://raw.githubusercontent.com/wabgls/permission/main/ip"
checking_sc() {
    ...
    if [[ $date_list < $useexp ]]; then
        ...
        echo -e "     \033[0;36mTelegram${NC}:  https://t.me/BogelStore1"
        echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
        exit
    fi
}
...
cd /usr/bin
clear
wget https://raw.githubusercontent.com/wabgls/autoscript-vip/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/wabgls/autoscript-vip/main/bot/kyt.zip
unzip kyt.zip
...
wget -q -O /usr/bin/addtrgo "https://raw.githubusercontent.com/wabgls/autoscript-vip/main/trgo/addtrgo.sh" && chmod +x /usr/bin/addtrgo

wget -q -O /usr/bin/deltrgo "https://raw.githubusercontent.com/wabgls/autoscript-vip/main/trgo/deltrgo.sh" && chmod +x /usr/bin/deltrgo

wget -q -O /usr/bin/cektrgo "https://raw.githubusercontent.com/wabgls/autoscript-vip/main/trgo/cektrgo.sh" && chmod +x /usr/bin/cektrgo

wget -q -O /usr/bin/renewtrgo "https://raw.githubusercontent.com/wabgls/autoscript-vip/main/trgo/renewtrgo.sh" && chmod +x /usr/bin/renewtrgo
